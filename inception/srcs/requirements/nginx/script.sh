...
sed -i "s/server_name example/server_name $HOST/g" /etc/nginx/nginx.conf
sed -i "s/server_name python.example/server_name python.$HOST/g" /etc/nginx/nginx.conf
sed -i "s/server_name portainer.example/server_name portainer.$HOST/g" /etc/nginx/nginx.conf
nginx -g 'daemon off;'
