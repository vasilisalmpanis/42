...
struct Endian<int64_t> {
	static int64_t toNetwork(int64_t value) { return static_cast<int64_t>(Endian<uint64_t>::toNetwork(value)); }
	static int64_t toHost(int64_t value) { return static_cast<int64_t>(Endian<uint64_t>::toHost(value)); }
};
